...
/** 
* @brief imprimirCoordenadas nos permite saber cuales son las coordenadas por las que pasa la recta.
* @param m Indica la pendiente.
* @param b Indica el punto de intercepción en el eje Y. 
* @param rango1 Indica el rango inicial, ingresado por el usario.
* @param rango2 Indica el rango final, ingresado por el usario.
* @param x Indica al eje x.
* @param y Indica al eje y.
* @return void
*/

void imprimirCoordenadas(int m, int b, int rango1, int rango2){
	double x[100], y [100];
	int i;
...
/** 
* @brief imprimirGrafica nos imprime la gráfica mediante Gnuplot.
* @param m Indica la pendiente.
* @param b Indica el punto de intercepción en el eje Y. 
* @param rango1 Indica el rango inicial, ingresado por el usario.
* @param rango2 Indica el rango final, ingresado por el usario.
* @return void
*/
void imprimirGrafica(int m, int b,int rango1, int rango2){
	gnuplot_ctrl * h1;
	
	printf("Grafica\n");
	h1 = gnuplot_init();
	gnuplot_cmd(h1,"set xrange [%d:%d]",rango1, rango2);
